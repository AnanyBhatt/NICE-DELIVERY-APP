...
class ResOrderDetails {
  ...
  factory ResOrderDetails.fromJson(Map<String, dynamic> json) => ResOrderDetails(
    ...
    data: json["data"] == null ? null : OrderMaster.fromJson(json["data"]),
...
class OrderMaster {
  ...
  dynamic paymentDate;
  double customerTotalOrderAmount;
  ...
  factory OrderMaster.fromJson(Map<String, dynamic> json) => OrderMaster(
    ...
    customerTotalOrderAmount: json["customerTotalOrderAmount"] == null ? null : json["customerTotalOrderAmount"],
  );
