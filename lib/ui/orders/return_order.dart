...
class ReturnOrderPage extends StatefulWidget {
  final int orderId;
  ReturnOrderPage({Key key, @required this.orderId}) : super(key: key);

  @override
  _ReturnOrderPageState createState() => _ReturnOrderPageState();
}

class _ReturnOrderPageState extends State<ReturnOrderPage> with Constants {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        child: Scaffold(
            ...
            appBar: CommonAppBar(
              appBar: AppBar(),
              title: "${AppTranslations.of(context).text("Key_ReturnOrder")}",
            ),
  ...
  apiReasonList(
    ...
    Response response = await RestClient.getData(
        context, ApiEndPoints.apiTicketReasonList + "RETURN", accessToken);
  ...
  apiReturnOrder(
    ...
    Response response = await RestClient.postData(
        context, ApiEndPoints.apiReturnOrder, data, accessToken);
